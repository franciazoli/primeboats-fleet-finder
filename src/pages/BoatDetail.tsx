...
import { getBoatBySlug, getRelatedBoats, formatPrice } from "@/data/boats";
...
const BoatDetail = () => {
  ...
  const boat = slug ? getBoatBySlug(slug) : undefined;
  ...
  const related = getRelatedBoats(boat);
      ...
      <div className="mt-6 grid gap-10 lg:grid-cols-[1.5fr_1fr]">
        ...
        <div className="lg:sticky lg:top-24 lg:self-start">
          ...
          <div className="mt-6 grid grid-cols-2 gap-3 rounded-lg border border-border bg-card p-4 text-sm">
            <div className="flex items-center gap-2"><Ruler className="h-4 w-4 text-accent" /> {boat.lengthMeters} m</div>
            <div className="flex items-center gap-2"><Calendar className="h-4 w-4 text-accent" /> {boat.year}</div>
            <div className="flex items-center gap-2"><Cog className="h-4 w-4 text-accent" /> {boat.engine}</div>
            <div className="flex items-center gap-2"><MapPin className="h-4 w-4 text-accent" /> {boat.location}</div>
